...
//    public static final int CONTROL_RANK            = ControlType.RANK.value;
    ...
    public static void main(String[] args) throws IllegalArgumentException, XFormTestSyntaxException, XFormTestAssertionTypeException {
        // #to-do @0.1Release: refactor rename fakeTestArgs-->args and delete next line, and remove noinspection.
        String[] fakeTestArgs = { "/Users/joeflack4/projects/xform-test/test/files/XformTest/output/XformTest1.xml" };
        //noinspection ConstantConditions
        if (fakeTestArgs.length > 1)
        ...
        String filePathStr = fakeTestArgs[0];
    ...
    private HashMap<String, String> nodeAssertions(TreeElement node) throws XFormTestSyntaxException, XFormTestAssertionTypeException {
...
//        System.out.println("result3: " + result3);
        // to-do: How to actually evaluate the calculate? Search javarosa source
