...
### Syntax for assertion expressions
...
XForm-test utilizes special columns for linear assertion. Any of the following 3 column names are valid.
...
### Setting up multiple linear scenario tests within a single form
